Feature: Cart functionality on SauceDemo
  ...
  Scenario: Proceed to checkout with valid information
    ...
    When user enters first name "Dilip"
    And user enters last name "Kumar"
    And user enters postal code "145412"
  ...
  Scenario: Proceed to checkout with missing first name
    ...
    When user enters first name "Dilip"
    And user enters last name "Kumar"
    And user enters postal code "533105"
    And user clicks on Continue
  ...
  Scenario: Complete checkout and finish order
    ...
    And user clicks on the cart icon
    And user clicks on Checkout
    And user enters first name "Dilip"
    And user enters last name "Kumar"
    And user enters postal code "470522"
    And user clicks on Continue
